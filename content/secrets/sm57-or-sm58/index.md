...
The SM58 also has a ball grille on top, with a thin layer of foam inside. The foam slightly dampens high frequencies, while the physical size of the ball grille keeps your mouth further from the diaphragm. This distance reduces the bass boost caused by the proximity effect[^proximity-effect], giving the SM58 a slightly tamer low-end response compared to the SM57. It also protects the mic from wind and plosives[^plosives]. The ball grille is also made of metal, affording additional protection against electromagnetic interference.
...
[^proximity-effect]: *Proximity effect* is the phenomenon where a directional microphone boosts low frequencies when the sound source is placed very close to the diaphragm.
