...
An audio interface is essential for recording directly into your computer from balanced audio equipment (such as with XLR cables[^xlr-cable]). While this is an important option to keep available, I do most of my microphone recording directly onto a portable recorder inside a dead room. While I could go down the audio interface route (which is far more common), it would mean keeping a computer inside the dead room so that I could reach the record button. This would also mean the computer fans would be picked up by the microphone. If I kept the computer further away, I'd have to hit the record button and dash across my flat to get into the dead room for each take. There are other ways around these problems, but I felt the most flexible solution was having a very quiet recording device that I can keep next to me.
